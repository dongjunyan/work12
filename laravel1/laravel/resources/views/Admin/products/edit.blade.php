       ...
       {{-- 隐藏域--}}
        <div class="row cl {{ ($errors->has('attribute.*') || $errors->has('items.*') || $errors->has('markup.*')) ? 'has-error' : '' }}" id="attrContainer">
            ...
            @foreach ($product->productAttributes as $attribute)
                <div class="">
                        <input type="hidden" name="attribute[]" id=""  value="0"  style=" width:25%" >
        ...
        <div class="row cl {{ $errors->has('unit') ? 'has-error' : '' }}">
            <div class="">
                <input type="hidden" name="unit" id="" value="人"  style="width:90%">
                @if ($errors->has('unit'))
                    <span class="help-block">
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                <input type="submit" class="layui-btn layui-btn-normal" value="修改教师">
            </div>
        </div>
    </form>
</div>
