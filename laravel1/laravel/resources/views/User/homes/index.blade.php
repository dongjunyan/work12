        ...
        <div class="wrap-left">
            <div class="wrap-list">
                <div class="m-user">
                    ...
                    <div class="m-userinfo">
                        ...
                        <div class="m-right">
                            ...
                            -->
                            <div class="m-address">
                                <a href="{{ url('/user/addresses') }}" class="i-trigger">我的教学区</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="m-order">
                    ...
                    <ul>
                        <li><a href="{{ url('/home/cars') }}"><i><img src="{{ asset('assets/user/images/send.png') }}"/></i><span>课程订单<em class="m-num">{{ $user->cars->count() }}</em></span></a></li>
